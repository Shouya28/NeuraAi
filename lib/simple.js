        ...
        if (global.db.data.settings[conn.user.jid].adReply) {
          ...
          return Buffer.isBuffer(text)
            ...
            : conn.adReply(
                ...
                "",
                global.thumbreply.getRandom() || fs.readFileSync("./media/" + thumb.getRandom() + ".jpg"),
                false,
                quoted,
                false,
                false,
        ...
        return conn.sendMessage(
          jid,
          {
            text: isSmlcap
              ? conn.smlcap(text, smlcap.except ? smlcap.except : false)
              : text,
           /* document: { url: 'https://telegra.ph/file/48a3dffb03628c3b737df.png' },
            jpegThumbnail: large ? await conn.resize(buffer, 300, 150) : await conn.resize(buffer, 400, 400),
            fileName: title,
            mimetype: large ? global.doc : 'audio/mpeg',
