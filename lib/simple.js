      ...
      value(jid, text = "", url, quoted, options) {
        conn.sendMessage(
          jid,
          {
            ...
            contextInfo: {
              externalAdReply: {
                title: global.db.data.bots.info.wm,
                body: "by Shouyaaa",
                showAdAttribution: true,
                mediaType: 1,
                sourceUrl: global.db.data.bots.link.group,
...
if (Array.isArray(json)) {
  json.forEach((item) => {
    ...
    newObj.buttonText.displayText = item[0];
    newObj.buttonId = item[1];
    buttons.push(newObj);
  });
} else {
  const newObj = { ...template };
  newObj.buttonText.displayText = json[0];
  newObj.buttonId = json[1];
  buttons.push(newObj);
}
        let message = {
          ...options,
        ...
        if (global.db.data.settings[conn.user.jid].adReply) {
          return Buffer.isBuffer(text)
            ...
            : conn.adReply(
                jid,
                text,
                global.db.data.bots.info.wm,
                global.db.data.bots.info.versi,
                global.assetUrls.thumb.getRandom(),
                false,
                quoted,
                false,
                false,
          ...
          jid,
          {
            ...
            contextInfo: {
              ...
              forwardedNewsletterMessageInfo: {
                ...
                newsletterName: `${global.db.data.bots.info.wm}`,
              },
              externalAdReply: {
                ...
                mediaUrl: assetUrls.thumb.getRandom(),
                sourceUrl: source,
              },
            },
          },
    ...
    sendNCarousel: {
      async value(
        ...
        const interactiveMessage = {
          body: {
            text: text || global.db.data.bots.info.wm,
          },
          footer: {
            text: footer || wm,
          },
      ...
      async value(jid, messages, quoted, options) {
        if (messages.length > 1) {
          ...
          const interactiveMessage = proto.Message.InteractiveMessage.create({
            ...
            header: proto.Message.InteractiveMessage.Header.fromObject({
              title: global.db.data.bots.info.author,
              subtitle: "Diperbarui hari ini",
              hasMediaAttachment: false,
            }),
            carouselMessage:
    ...
    sendCopy: {
      ...
      async value(jid, head = "", body = "", footer = "", json, m) {
        const template = [
          {
            name: "cta_copy",
            buttonParamsJson: '{"display_text":"dispText","id":"idText","copy_code":"copyText"}',
          },
        ];
              ...
              message: {
                ...
                interactiveMessage: proto.Message.InteractiveMessage.create({
                  ...
                  contextInfo: {
                    ...
                    externalAdReply: {
                      title: title || wm,
                      thumbnailUrl: thumb || global.assetUrls.thumb,
                      sourceUrl: "",
                      mediaType: 2,
